...
private:
	...
	void draw_ghost(IClientEntity * pEntity, player_info_t pinfo);
	...
	void DrawArmorBar(IClientEntity * pEntity, Box size);

	void DrawVitals_Armor(IClientEntity * pEntity, Box size);
