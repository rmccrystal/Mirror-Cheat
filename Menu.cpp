...
#pragma region Aimbot
	...
	resolver.AddItem("Legacy Prediction");
	resolver.AddItem("Anti Desync Brute");
	...
	headonly_if_vis.SetFileId("headonly_if_vis");
	AimbotGroup.PlaceLabledControl(3, "Headshot Only If Hittable", this, &headonly_if_vis);
	// -<--------------------------------------------------------------->- //
	...
	weapongroup.SetPosition(4, 230); // 15, 230
	weapongroup.SetSize(550, 210);
	...
	target_auto2.SetFileId("tgt_hitscan_auto");
	...
	weapongroup.PlaceLabledControl(5, "Hitscan", this, &target_otr2);
...
//	OptionsGroup.PlaceLabledControl(1, "Offscreen ESP", this, &OffscreenESP);
	...
	beamtime.SetValue(2);
	OptionsGroup.PlaceLabledControl(3, "Tracer Time", this, &beamtime);

	//	DamageIndicator.SetFileId("otr_because_all_people_want_is_a_skeet_ripoff");
	...
	ChamsGroup.SetPosition(284, 30); // 225, 30
...
#pragma region WORLD IS DOOMED AND FLAT AND GAY AND TRUMP IS LITERALLY HITLER AND FREAK IS THE QUEEN OF MARS
	...
	worldgroup.SetPosition(284, 285);  // 225, 285
...
#pragma region Other
	...
	CircleStrafeKey.SetFileId("otr_c_strafe");
	OtherGroup.PlaceLabledControl(1, "Circle Strafe", this, &CircleStrafeKey);

	Zstrafe.SetFileId("otr_Zstrafe");
	OtherGroup.PlaceLabledControl(1, "Z Strafe", this, &Zstrafe);
	...
	OtherGroup.PlaceLabledControl(1, "Sniper Crosshair", this, &SniperCrosshair);
...
//	OtherGroup.PlaceLabledControl(1, "", this, &ThirdPersonVal);

	DebugHitbones.SetFileId("multipoint_debug");
	OtherGroup.PlaceLabledControl(1, "Debug Multipoint", this, &DebugHitbones);

//	aa_helper2.SetFileId("aahelper2");
//	OtherGroup.PlaceLabledControl(1, "Anti Aim Arrows", this, &aa_helper2);

	lby_helper.SetFileId("aahelper");
	OtherGroup.PlaceLabledControl(1, "Lowerbody Angle Ghost", this, &lby_helper);

	slidewalk.SetFileId("slidewalk");
	OtherGroup.PlaceLabledControl(1, "Slidewalk", this, &slidewalk);

	DisablePostProcess.SetFileId("DisablePostProces");
	OtherGroup.PlaceLabledControl(1, "Disable Post Processing", this, &DisablePostProcess);
	...
	AntiAimPitch.AddItem("Autist Down (!)");
...
//	custom_pitch.SetFileId("custompitch");
//	custom_pitch.SetBoundaries(-89.f, 89.f);
//	custom_pitch.SetValue(0.f);
//	AntiAimGroup.PlaceLabledControl(1, "Custom Pitch", this, &custom_pitch);
	...
	AntiAimYaw.AddItem("FreaKy");
	AntiAimYaw.AddItem("180 Jitter");
	AntiAimGroup.PlaceLabledControl(1, "Standing Yaw", this, &AntiAimYaw);

	standing_desync_offset.SetFileId("v_standing_desync_offset");
	standing_desync_offset.SetBoundaries(0, 58.f);
	standing_desync_offset.SetValue(0.f);
	AntiAimGroup.PlaceLabledControl(1, "Desync Ammount", this, &standing_desync_offset);
	...
	AntiAimYawrun.AddItem("FreaKy");
	AntiAimYawrun.AddItem("180 Jitter");
	AntiAimGroup.PlaceLabledControl(1, "Moving Yaw", this, &AntiAimYawrun);

	moving_desync_offset.SetFileId("v_moving_desync_offset");
	moving_desync_offset.SetBoundaries(0, 58.f);
	moving_desync_offset.SetValue(0.f);
	AntiAimGroup.PlaceLabledControl(1, "Desync Ammount", this, &moving_desync_offset);
	...
	AntiAimYaw3.AddItem("FreaKy");
	AntiAimYaw3.AddItem("180 Jitter");
	AntiAimGroup.PlaceLabledControl(1, "InAir Yaw", this, &AntiAimYaw3);

	air_desync_offset.SetFileId("v_air_desync_offset");
	air_desync_offset.SetBoundaries(0, 58.f);
	air_desync_offset.SetValue(0.f);
	AntiAimGroup.PlaceLabledControl(1, "Desync Ammount", this, &air_desync_offset);

	pitch_up.SetFileId("pitch_up");
	AntiAimGroup.PlaceLabledControl(1, "Pitch Flick", this, &pitch_up);


	do_freestanding.SetFileId("freestanding");
	AntiAimGroup.PlaceLabledControl(1, "Freestanding", this, &do_freestanding);
	...
	freestandtype.SetFileId("b_freestanding_type");
	AntiAimGroup.PlaceLabledControl(2, "Freestanding Spin Mode", this, &freestandtype);

	freerange.SetFileId("freestanding_range");
	freerange.SetBoundaries(0, 60);
	freerange.SetValue(35);
	AntiAimGroup.PlaceLabledControl(2, "Freestanding Value", this, &freerange);
	...
	fl_spike_shoot.SetFileId("fakelag_spike_shoot");
	AntiAimGroup.PlaceLabledControl(2, "Fakelag Spike On Shoot", this, &fl_spike_shoot);

	fl_spike_jump.SetFileId("fakelag_spike_peakofjump");
	AntiAimGroup.PlaceLabledControl(2, "Fakelag Spike In Peak Of Jump", this, &fl_spike_jump);

	fl_spike_onpeek.SetFileId("fakelag_spike_onpeek");
	AntiAimGroup.PlaceLabledControl(2, "Fakelag Spike On Peek", this, &fl_spike_onpeek);
	...
	lby1.SetValue(60);
	AntiAimGroup.PlaceLabledControl(3, "Lowerbody Ammount", this, &lby1);
...
#pragma region Visual Colors
	...
	BoxColteam.SetFileId(XorStr("player_espbox_color_team"));
	ColorsGroup.PlaceLabledControl(1, XorStr("Box Team"), this, &BoxColteam);

	Skeleton.SetFileId(XorStr("player_skeleton_color"));
	ColorsGroup.PlaceLabledControl(1, XorStr("Skeleton Enemy"), this, &Skeleton);

	Skeletonteam.SetFileId(XorStr("player_skeleton_color_team"));
	...
	Ammoteam.SetFileId(XorStr("player_ammo_color"));
	ColorsGroup.PlaceLabledControl(1, XorStr("Ammo Team"), this, &Ammoteam);
	...
	ColorsGroup.PlaceLabledControl(2, XorStr("Chams Enemy"), this, &ChamsEnemyVis);
	ChamsEnemyNotVis.SetFileId(XorStr("player_chamsENVIS_color"));
	ColorsGroup.PlaceLabledControl(2, XorStr("Chams Enemy (Behind Wall)"), this, &ChamsEnemyNotVis);

	ChamsTeamVis.SetFileId(XorStr("player_ChamsTeamVis"));
	ColorsGroup.PlaceLabledControl(2, XorStr("Chams Team"), this, &ChamsTeamVis);
	...
	ConfigGroup.SetPosition(280, 30);
	ConfigGroup.SetSize(254, 335);
...
//	OtherOptions.PlaceLabledControl(0, XorStr("BackTrack Chams"), this, &BackTrackBones);
	...
	OtherOptions2.SetPosition(280, 373);
	OtherOptions2.SetSize(254, 70);
...
//	OtherOptions2.PlaceLabledControl(0, XorStr("Experimental Position Adjustment"), this, &experimental_backtrack);
	...
	OtherOptions2.PlaceLabledControl(0, XorStr("Quick Stop Speed"), this, &quickstop_speed);
