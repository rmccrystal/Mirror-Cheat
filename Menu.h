...
public:
	...
	CKeyBind bigbaim;
	CCheckBox headonly_if_vis;
	CCheckBox extrapolation;

	CCheckBox resolver_dofreestanding;
	CCheckBox resolver_predictlby;
	CCheckBox resolver_predict_inair;
	CCheckBox resolver_compensate_performance;
...
public:
	...
	CComboBoxYeti desync_aa_stand;
	CComboBoxYeti desync_aa_move;
	...
	CCheckBox auto_fakelag;
	CKeyBind ThirdPersonKeyBind;
	CSlider FakeWalkSpeed;
	CSlider ThirdPersonValue;
	CSlider standing_desync_offset;
	CSlider moving_desync_offset;
	CSlider air_desync_offset;
	CSlider twitchf;
	CSlider spinf;
	CSlider randlbyr;
	CSlider randlbyf;
	...
	CCheckBox fl_spike_shoot;
	CCheckBox fl_spike_jump;
	CCheckBox fl_spike_reload;
	CCheckBox fl_spike_onpeek;
};
